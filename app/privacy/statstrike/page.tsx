    ...
    <main className="min-h-screen bg-gradient-to-b from-[#111827] to-[#1f2937] text-white">
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="space-y-6 text-sm md:text-base leading-relaxed text-white/90 mb-16">
          ...
          <h3 className="text-xl font-semibold mt-6">4a. StatStrike Web — 24h pass (Lemon Squeezy)</h3>
          <p>
            The browser version at thegoallab.net may offer a one-time 24-hour pass processed by{' '}
            <span className="font-semibold">Lemon Squeezy</span> (payment provider). When you create
            a pass we may store: order identifiers, amount, pass expiry, an access token hash (not
            the raw token), optional email, and consent choices you make on the Create Pass page.
          </p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>
