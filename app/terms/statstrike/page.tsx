...
export const metadata: Metadata = {
  title: 'StatStrike — Terms of Use',
  description:
    'Terms of Use for StatStrike, a football prediction and betting advice app.',
};

export default function StatStrikeTermsPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#111827] to-[#1f2937] text-white">
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <section className="space-y-6 text-sm md:text-base leading-relaxed text-white/90">
          <p>
            Welcome to StatStrike. By downloading, installing, or using this application, you agree
          ...
          <p>
            StatStrike is a football prediction and statistical analysis application. It provides
            predictions, forecasts, and statistical information based on historical match data,
            team performance metrics, and pattern analysis algorithms.
          </p>
          <p className="font-semibold text-yellow-400">
            StatStrike is for informational and entertainment purposes only. Predictions are not
          ...
          <p>
            StatStrike does not provide gambling, betting, or financial advice. The app presents
          ...
          <p>
            If you choose to use the information provided by StatStrike for betting purposes, you
          ...
          <p>
            StatStrike is intended for users aged 18 years and older. By using this app, you
          ...
          <p className="mt-4">
            ...
            <a href="https://www.begambleaware.org" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-300">
              BeGambleAware.org
            </a>{' '}
            (UK) or equivalent services in your country.
          </p>

          <h2 className="text-xl font-semibold mt-8">5. Subscriptions and Payments</h2>
          <p>
            StatStrike offers premium features through auto-renewable subscriptions managed by
          ...
          <p>
            StatStrike uses third-party data sources for fixture information, statistics, and
          ...
          <p>
            To the fullest extent permitted by law, the developer of StatStrike shall not be
          ...
          <p>
            StatStrike, including its design, features, and content, is protected by copyright
          ...
          <p>
            We reserve the right to terminate or suspend access to StatStrike at any time, without
          ...
          <p className="mt-2">
            ...
            <a
              href="mailto:jmclarenscripts@gmail.com?subject=StatStrike%20Terms%20of%20Use"
          ...
          <div className="mt-12 pt-8 border-t border-white/10">
            <p className="text-white/60 text-sm">
              By using StatStrike, you acknowledge that you have read, understood, and agree to
