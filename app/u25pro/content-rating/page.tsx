...
export const metadata: Metadata = {
  title: 'U25Pro — Age & Content Rating',
  description:
    'Age suitability and content rating information for U25Pro, an Under 2.5 Goals football prediction app.',
};

export default function U25ProContentRatingPage() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#0c1929] to-[#164e63] text-white">
      <div className="max-w-3xl mx-auto px-4 py-12 md:py-16">
        ...
        <h1 className="text-3xl md:text-4xl font-bold mb-4">
          U25Pro — Age &amp; Content Rating
        </h1>
        <p className="text-sm text-white/60 mb-8">
          This page explains the type of content included in U25Pro so you can decide
        ...
        <section className="space-y-6 text-sm md:text-base leading-relaxed text-white/90">
          ...
          <p>
            U25Pro is intended for users who are <span className="font-semibold">18 years of age or older</span>.
          ...
          <p>
            U25Pro provides statistical analysis and predictions specifically for Under 2.5 Goals
            betting markets. The app includes:
          </p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>Statistical analysis of football fixtures focused on low-scoring matches</li>
            <li>Under 2.5 Goals prediction forecasts</li>
            <li>Confidence scoring and prediction recommendations</li>
            <li>Historical performance tracking and match statistics</li>
          </ul>
          <p className="mt-4">
            <span className="font-semibold">Important:</span> U25Pro provides informational
          ...
          <p>
            U25Pro displays advertisements through Google AdMob. Users can remove advertisements
            by purchasing ad-free access through the app. Advertisements may include:
          </p>
          <ul className="list-disc list-inside space-y-1 ml-4">
            <li>Banner advertisements at the bottom of the screen</li>
            <li>Ads may be personalized based on your interests (can be disabled in device settings)</li>
          </ul>
          ...
          <p>
            U25Pro is rated <span className="font-semibold">18+</span> on the App Store due
            to its gambling-related content and betting advice nature.
          </p>

          <h2 className="text-xl font-semibold mt-4">Responsible Use</h2>
          <p>
            U25Pro is designed to provide statistical insights and predictions for
          ...
          <p>
            This application provides statistical football data and predictive analysis focused
            on Under 2.5 Goals markets. The content is supplied for information and entertainment
            purposes only and does not constitute betting advice, financial advice, or a
            recommendation to place wagers.
          </p>
          <p>
          ...
          <p>
            U25Pro is an <span className="font-semibold">Under 2.5 Goals specialist prediction
            tool</span> for football matches, intended for adults who are interested in
            data-driven betting insights for low-scoring match markets. The app contains no
            violent, sexual, or graphic content, but does provide betting-related advice that
            is restricted to users 18 years and older.
          </p>
