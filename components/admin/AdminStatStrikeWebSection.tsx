  ...
  return (
    <section className="rounded-2xl border border-white/15 bg-white/5 p-6 space-y-4">
      ...
      <p className="text-xs text-white/50 leading-relaxed">
        ...
        <code className="text-white/70">statstrikeWebConfig</code> in Realtime Database. Public site
        reads via <code className="text-white/70">/api/statstrike/web-config</code> (works without
        new RTDB client read rules). Missing node defaults to blur{' '}
        <strong className="text-white/65">ON</strong>.
      </p>
