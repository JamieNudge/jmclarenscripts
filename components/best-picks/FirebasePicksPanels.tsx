  ...
  return (
    <div className="grid grid-cols-1 gap-4 md:gap-5">
      ...
      {manualPathDiagnostic && (
        <div
          className="rounded-xl border border-red-400/35 bg-red-950/40 px-4 py-3 text-sm text-red-100/95 leading-relaxed"
          role="alert"
        >
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-5 md:[grid-template-rows:repeat(2,minmax(0,26rem))] [&>*]:min-h-0">
