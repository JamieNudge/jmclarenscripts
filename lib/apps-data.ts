...
export const apps: App[] = [
  ...
  },
  {
    ...
    name: 'Icon Resizer',
    tagline: 'App icons, screenshots, and web headers from one image',
    description:
      'A native macOS utility for designers and developers: drag in a master PNG (or use the built-in Image lab crop), then generate Xcode-ready iOS and macOS App Icon sets, Android launcher mipmaps, store screenshots, and fixed-size web headers. Exports respect sandboxed folder access on the Mac App Store build.',
    color: '#8B5CF6',
    icon: '/images/icon-resizer-apple-apps-icon.png',
    screenshots: [],
    features: [
      'iOS AppIcon.appiconset + macOS icon sizes from one source image',
      'Image lab: square crop in pixels, export presets, optional 1024×1024 hand-off to icon mode',
      'Android res/mipmap launcher icons plus Play-style 512×512 listing asset',
      'App Store screenshot batches (iPhone, iPad, Watch) and Android phone/tablet sizes',
      'Web header exports with aspect-fill crop (no stretch)',
      'SwiftUI interface with drag-and-drop and sensible defaults',
    ],
    platform: 'macOS',
    status: 'beta',
