...
export const apps: App[] = [
  ...
  },
  {
    id: 'stat-secrets',
    name: 'Stat Secrets',
    tagline: 'Football Prediction Engine',
    description: 'Stat Secrets uses a proprietary statistical engine to identify football matches most likely to be high-scoring. Daily picks, live score tracking, and goal notifications — all powered by data.',
    color: '#F97316',
    icon: '/images/stat-secrets-icon.png',
    screenshots: [
      '/images/stat-secrets-1.png',
      '/images/stat-secrets-2.png',
      '/images/stat-secrets-3.png',
    ],
    features: [
      'Proprietary prediction algorithm',
      'Daily Over/Under goal picks',
      'Live score tracking via Lock Screen',
      'Goal notifications in real-time',
      'Track Record to monitor accuracy',
      'Quality confidence scores',
    ],
    platform: 'iOS',
    status: 'beta',
    supportUrl: '/support/stat-secrets',
    privacyUrl: '/privacy/stat-secrets',
    disclaimerUrl: '/disclaimer/stat-secrets',
  },
  {
    id: 'recipe-saviour',
    name: 'Recipe Saviour',
