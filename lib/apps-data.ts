...
export const apps: App[] = [
  ...
  },
  {
    id: 'u25pro',
    name: 'U25Pro',
    tagline: 'Under 2.5 Goals Specialist',
    description: 'A focused football prediction app specializing in Under 2.5 Goals markets. U25Pro uses a proprietary unanimous selection algorithm to identify high-confidence low-scoring matches, with transparent track record and ad-supported free tier.',
    color: '#06B6D4',
    icon: '/images/u25pro-icon.png',
    screenshots: [],
    features: [
      'Specialized Under 2.5 Goals predictions',
      'Unanimous selection algorithm',
      'Firebase real-time data sync',
      'Transparent track record with live results',
      'Ad-supported with premium ad-free option',
      'Clean, focused UI for quick decision making',
    ],
    platform: 'iOS',
    status: 'in-review',
    contentRatingUrl: '/u25pro/content-rating',
    privacyUrl: '/privacy/u25pro',
    termsUrl: '/terms/u25pro',
  },
  {
    id: 'recipe-saviour',
    name: 'Recipe Saviour',
